...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> dash-components-table-own -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import dash-components-table-own to your layout, then run it:
